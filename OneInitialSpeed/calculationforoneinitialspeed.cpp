...
ofstream outfile_position("positiononespeed.txt");
...
int main(){
      cout<< "------------------------------------------\n"
          << "This simulates a system of particles with a single one having initial velocity and rest are static.\n"
